...
<div class="max-w-6xl mx-auto py-8 px-4">
    <h2 class="text-3xl font-bold mb-6">Progress Ticket</h2>
        ...
        <form action="{{ route('progress') }}" method="GET" class="flex gap-4">
            <div class="flex-1">
                <input type="text" 
                       ...
                       placeholder="Cari berdasarkan Ticket ID, Nama, Email, atau No HP..."
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-gray-600">{{ $t->phone ?? '-' }}</td>
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-20 text-center">
                            <div class="flex flex-col items-center justify-center text-gray-400">
                                ...
                                <p class="text-xl font-semibold text-gray-600 mb-2">Gunakan pencarian untuk melihat ticket</p>
                                <p class="text-gray-500">Masukkan Ticket ID, Nama, Email, atau No HP di kolom pencarian</p>
                            </div>
                        </td>
                    </tr>
                </tbody>
